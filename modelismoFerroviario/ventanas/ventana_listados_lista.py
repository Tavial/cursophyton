...
class Ui_ventanaListadosLista(object):
    def setupUi(self, ventanaListadosLista):
        ...
        self.separador1.setGeometry(QtCore.QRect(0, 40, 531, 20))
        ...
        self.separador2.setGeometry(QtCore.QRect(810, 40, 491, 20))
        ...
        self.visor_listado.setGeometry(QtCore.QRect(20, 90, 1261, 771))
